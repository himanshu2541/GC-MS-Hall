...
const Navbar = () => {
  ...
  const renderSubscriptionButton = () => {
    ...
    if (auth.roles.includes("tier3")) {
      return (
        <div className="group">
          <button className="bg-red-600 hover:bg-red-800 text-white font-bold py-2 px-4 rounded mr-4 relative">
            Basic
            <span
              className="absolute top-full left-0 mt-1 px-2 py-1 font-normal  bg-yellow-700  hover:bg-yellow-500 hover:text-gray-900 hover:font-medium text-xs text-white rounded upgrade-text opacity-0 transition-opacity duration-300 group-hover:opacity-100"
    ...
    } else if (auth.roles.includes("tier2")) {
      return (
        <div className="group">
          <button className="bg-red-600 hover:bg-red-800 text-white font-bold py-2 px-4 rounded mr-4 relative">
            Standard
    ...
    } else if (auth.roles.includes("tier1")) {
      return (
      ...
      return (
        <button
          className="bg-red-600 hover:bg-red-800 text-white font-bold py-2 px-4 rounded mr-4"
          onClick={handleSubscribe}
        >
          Subscribe
        </button>
  ...
  return (
    <div className="flex items-center justify-between px-4 py-2 sm:px-6 lg:px-8 w-full absolute top-0 z-50 shadow- border-none">
      ...
      <div className="flex">
        <div className="mr-4">{renderUserIcon()}</div>
